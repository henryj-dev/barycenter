 ...
 *
 * GUI 가 빼는 것은 listener · httpRoute · passthroughRoute · sniBinding · backend 다.
 * backend 는 이미 있다. 인증서·TLS 정책은 EditKind 가 아니라 여기서 안 연다.
 */
...
import { sniBindingDelete, sniBindingDeletePatch } from '../../src/cli/tls.js';
